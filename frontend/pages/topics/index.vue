<template>
  <div class="container">
    ...
    <div v-for="(topic, index) in topics" :key="index" class="bg-light mt-5 mb-5" style="padding: 20px;">
      ...
      <div v-for="(content, index) in topic.posts" :key="index" class="ml-5 content">
        ...
        <!-- add likes button -->
        <div class="btn btn-outline-primary fa fa-thumbs-up ml-5 mb-5" @click="likePost(topic.id, content)">
  ...
  <nav>
    <ul class="pagination justify-content-center" >
      <li v-for="(id, value) in links" class="page-item">
        <a @click="loadMore(id)" href="#" class="page-link">{{value}}</a>
      </li>
    </ul>
  </nav>
